        ...
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question_treatment') ? 'is-invalid' : '' }}" name="question_treatment" id="question_treatment" required>{{ old('question_treatment') }}</textarea>
                @if($errors->has('question_treatment'))
                    <div class="invalid-feedback">
                        {{ $errors->first('question_treatment') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.question.fields.question_treatment_helper') }}</span>
            </div>
